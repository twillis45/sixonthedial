...
| 1.7 | Content rating (IARC via Play, Apple age rating) | **SWEPT 2026-08-26 — one item needs a ruling** | Word game, no violence. Check the wordlist question below first. |
