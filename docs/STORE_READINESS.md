...
| 3.2 | Google Play Developer — $25 once | **DONE 2026-08-27** | Organization account, `No Guesswork Systems LLC`, owner `toddswillis@gmail.com`, fee receipted. Organization rather than personal was the right call twice over: an individual account cannot be converted later without support, and the **12-testers-for-14-days closed-testing requirement applies only to personal accounts created after Nov 2023** — organizations are exempt, which saves two weeks at submission. Identity and D-U-N-S verification may still be pending; the phone field wanted a carrier number and refused VoIP, so whatever number was verified must be reconciled against the entity block above. |
