...
| 3.2 | Google Play Developer — $25 once | **DONE 2026-08-27** | Organization account, `No Guesswork Systems LLC`, owner `toddswillis@gmail.com`, fee receipted. Organization rather than personal was the right call twice over: an individual account cannot be converted later without support, and the **12-testers-for-14-days closed-testing requirement applies only to personal accounts created after Nov 2023** — organizations are exempt, which saves two weeks at submission. **Verifications completed 2026-08-27** — identity, organization and phone, all inside the signup day. **The verified line is (240) 782-0827**, the LLC number in the entity block above, so nothing drifted: the console, this doc and the trademark application will all carry the same number. The field's initial refusal was formatting, not the carrier — it wants unspaced digits, `+12407820827`. |
